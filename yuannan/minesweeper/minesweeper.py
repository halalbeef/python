#/usr/bin/env python
#stole this from someone from github, please credit them if you know who it is
...
def playgame():
    gridsize=int(input("How big do you want the grid?\n"))
    numberofmines=int(input("How many mines do you want?\n"))
